...
require (
	...
	github.com/consensys/gnark v0.0.0-20230906143445-e774bad393fd
...
replace (
	...
	github.com/consensys/gnark => github.com/celer-network/gnark v0.0.0-20230914091916-f66fafe2d842
