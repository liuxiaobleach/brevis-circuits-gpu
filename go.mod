...
replace (
	...
	github.com/consensys/gnark => github.com/celer-network/gnark v0.0.0-20230904023235-5da20fae7380
	...
	github.com/ingonyama-zk/icicle => github.com/ingonyama-zk/icicle v0.0.0-20230831061944-5667f32bfedd
