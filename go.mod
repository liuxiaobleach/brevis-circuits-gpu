...
replace (
	...
	// github.com/consensys/gnark => github.com/celer-network/gnark v0.0.0-20231024045756-2e07d4be705d
	github.com/consensys/gnark => github.com/celer-network/gnark v0.0.0-20231024045756-0ee8c6147261
